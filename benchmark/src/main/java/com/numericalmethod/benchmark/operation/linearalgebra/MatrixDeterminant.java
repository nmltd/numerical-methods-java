...
/**
 * Runtime benchmark tests of matrix determinant.
 *
 * @author Song Lin
 */
public class MatrixDeterminant implements BenchmarkOperation {

    private final int matrixSize;

    public MatrixDeterminant(int matrixSize) {
        this.matrixSize = matrixSize;
    }

    @Override
    public String getTitle() {
        return String.format("matrix determinant (%dx%d)", matrixSize, matrixSize);
    }
