...
/**
 * Runtime benchmark tests of matrix scale.
 *
 * @author Song Lin
 */
public class MatrixScale implements BenchmarkOperation {

    public static final double SCALAR = 0.5;
    private final int nRows;
    private final int nCols;

    public MatrixScale(int nRows, int nCols) {
        this.nRows = nRows;
        this.nCols = nCols;
    }
    ...
    public String getTitle() {
        return String.format("matrix scale (%dx%d)", nRows, nCols);
    }
