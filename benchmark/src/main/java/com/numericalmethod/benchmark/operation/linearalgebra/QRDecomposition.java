...
/**
 * Runtime benchmark tests of (general) QR decomposition.
 *
 * @author Song Lin
 */
public class QRDecomposition implements BenchmarkOperation {

    private final int nRows;
    private final int nCols;

    public QRDecomposition(int nRows, int nCols) {
        this.nRows = nRows;
        this.nCols = nCols;
    }
    ...
    public String getTitle() {
        return String.format("QR decomposition (%dx%d)", nRows, nCols);
    }
