...
public class Chapter10 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        chapter10.solve_by_brute_force_search_1();
        chapter10.solve_by_brute_force_search_2();
        chapter10.solve_by_brute_force_search_3();
        chapter10.solve_by_brute_force_search_4();
        chapter10.solve_loggamma_by_bracketing();
        chapter10.solve_by_steepest_descent();
        chapter10.solve_by_Newton_Raphson();
        chapter10.solve_by_Gauss_Newton();
        chapter10.solve_by_conjugate_direction_methods();
        chapter10.solve_by_quasi_Newton();
    }
